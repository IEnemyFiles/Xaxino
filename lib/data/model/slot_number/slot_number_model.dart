...
SlotNumberDataModel slotNumberDataModelFromJson(String str) => SlotNumberDataModel.fromJson(json.decode(str));

String slotNumberDataModelToJson(SlotNumberDataModel data) => json.encode(data.toJson());
...
class SlotNumberDataModel {
    ...
    factory SlotNumberDataModel.fromJson(Map<String, dynamic> json) => SlotNumberDataModel(
        remark: json["remark"],
        status: json["status"],
...
class Game {
    ...
    factory Game.fromJson(Map<String, dynamic> json) => Game(
        ...
        probableWin: json["probable_win"] == null ? [] : List<String>.from(json["probable_win"]!.map((x) => x)),
        type: json["type"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "probable_win": probableWin == null ? [] : List<dynamic>.from(probableWin!.map((x) => x)),
        "type": type,
