...
SpinWheelSubmitAnsModel spinWheelSubmitAnsModelFromJson(String str) => SpinWheelSubmitAnsModel.fromJson(json.decode(str));

String spinWheelSubmitAnsModelToJson(SpinWheelSubmitAnsModel data) => json.encode(data.toJson());
...
class SpinWheelSubmitAnsModel {
    ...
    factory SpinWheelSubmitAnsModel.fromJson(Map<String, dynamic> json) => SpinWheelSubmitAnsModel(
        remark: json["remark"],
        status: json["status"],
