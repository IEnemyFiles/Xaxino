...
BlackJackHitModel BlackJackHitModelFromJson(String str) => BlackJackHitModel.fromJson(json.decode(str));

String BlackJackHitModelToJson(BlackJackHitModel data) => json.encode(data.toJson());
...
class BlackJackHitModel {
    ...
    factory BlackJackHitModel.fromJson(Map<String, dynamic> json) => BlackJackHitModel(
        remark: json["remark"],
        status: json["status"],
...
class Data {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "cardImg": cardImg == null ? [] : List<dynamic>.from(cardImg!.map((x) => x.toString())),
        "game_log": gameLog?.toJson(),
        "card": card == null ? [] : List<dynamic>.from(card!.map((x) => x.toString())),
    };
}
