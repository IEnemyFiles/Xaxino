...
BlackJackAnswerModel blackJackAnswerModelFromJson(String str) => BlackJackAnswerModel.fromJson(json.decode(str));

String blackJackAnswerModelToJson(BlackJackAnswerModel data) => json.encode(data.toJson());
...
class BlackJackAnswerModel {
    ...
    factory BlackJackAnswerModel.fromJson(Map<String, dynamic> json) => BlackJackAnswerModel(
        remark: json["remark"],
        status: json["status"],
