...
GuessTheNumberSubmitAnsModel GuessTheNumberSubmitAnsModelFromJson(String str) => GuessTheNumberSubmitAnsModel.fromJson(json.decode(str));

String GuessTheNumberSubmitAnsModelToJson(GuessTheNumberSubmitAnsModel data) => json.encode(data.toJson());
...
class GuessTheNumberSubmitAnsModel {
    ...
    factory GuessTheNumberSubmitAnsModel.fromJson(Map<String, dynamic> json) => GuessTheNumberSubmitAnsModel(
        remark: json["remark"],
        status: json["status"],
