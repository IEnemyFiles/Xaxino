...
GameScreenModel GameScreenModelFromJson(String str) => GameScreenModel.fromJson(json.decode(str));

// ignore: non_constant_identifier_names
String GameScreenModelToJson(GameScreenModel data) => json.encode(data.toJson());
...
class GameScreenModel {
    ...
    factory GameScreenModel.fromJson(Map<String, dynamic> json) => GameScreenModel(
        remark: json["remark"],
        status: json["status"],
