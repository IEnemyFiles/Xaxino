...
GameLogModel gameLogModelFromJson(String str) => GameLogModel.fromJson(json.decode(str));
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        gameLogs: json["game_logs"] == null ? [] : List<GameLog>.from(json["game_logs"]!.map((x) => GameLog.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "game_logs": gameLogs == null ? [] : List<dynamic>.from(gameLogs!.map((x) => x.toJson())),
    };
}
...
class GameLevel {
  ...
  factory GameLevel.fromJson(Map<String, dynamic> json) => GameLevel(
        ...
        levels: json["levels"] == null
            ? null
            : List<LevelElement>.from(json["levels"].map((x) => LevelElement.fromJson(x))),
      );
