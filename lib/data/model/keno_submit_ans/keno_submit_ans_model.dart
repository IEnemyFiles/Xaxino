...
KenoSubmitAnsModel kenoSubmitAnsModelFromJson(String str) => KenoSubmitAnsModel.fromJson(json.decode(str));

String kenoSubmitAnsModelToJson(KenoSubmitAnsModel data) => json.encode(data.toJson());
...
class KenoSubmitAnsModel {
    ...
    factory KenoSubmitAnsModel.fromJson(Map<String, dynamic> json) => KenoSubmitAnsModel(
        remark: json["remark"],
        status: json["status"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        userSelect: json["user_select"] == null ? [] : List<String>.from(json["user_select"]!.map((x) => x.toString())),
        matchNumber: json["match_number"] == null ? [] : List<String>.from(json["match_number"]!.map((x) => x.toString())),
        balance: json["balance"]?.toString(),
    );

    Map<String, dynamic> toJson() => {
        "game_log": gameLog?.toJson(),
        "user_select": userSelect == null ? [] : List<String>.from(userSelect!.map((x) => x.toString())),
        "match_number": matchNumber == null ? [] : List<String>.from(matchNumber!.map((x) => x.toString())),
        "balance": balance,
    };
}
