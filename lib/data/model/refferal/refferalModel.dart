...
RefferalDataModel refferalDataModelFromJson(String str) => RefferalDataModel.fromJson(json.decode(str));

String refferalDataModelToJson(RefferalDataModel data) => json.encode(data.toJson());
...
class RefferalDataModel {
    ...
    factory RefferalDataModel.fromJson(Map<String, dynamic> json) => RefferalDataModel(
        remark: json["remark"],
        status: json["status"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        referralUsers: json["referral_users"] == null ? null : ReferralUsers.fromJson(json["referral_users"]),
        level: json["level"],
    );
...
class ReferralUsers {
   ...
   String? ev;
    ...
    factory ReferralUsers.fromJson(Map<String, dynamic> json) => ReferralUsers(
        ...
        allReferrals: json["all_referrals"] == null ? [] : List<ReferralUsers>.from(json["all_referrals"]!.map((x) => ReferralUsers.fromJson(x))),
        referrer: json["referrer"] == null ? null : ReferralUsers.fromJson(json["referrer"]),
    );
