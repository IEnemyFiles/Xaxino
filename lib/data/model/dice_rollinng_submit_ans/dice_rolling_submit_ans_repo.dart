...
DiceRollingSubmitAnsModel diceRollingSubmitAnsModelFromJson(String str) => DiceRollingSubmitAnsModel.fromJson(json.decode(str));

String diceRollingSubmitAnsModelToJson(DiceRollingSubmitAnsModel data) => json.encode(data.toJson());
...
class DiceRollingSubmitAnsModel {
    ...
    factory DiceRollingSubmitAnsModel.fromJson(Map<String, dynamic> json) => DiceRollingSubmitAnsModel(
        remark: json["remark"],
        status: json["status"],
