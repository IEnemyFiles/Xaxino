...
BlackJackInvestModel blackJackInvestModelFromJson(String str) => BlackJackInvestModel.fromJson(json.decode(str));

String blackJackInvestModelToJson(BlackJackInvestModel data) => json.encode(data.toJson());
...
class BlackJackInvestModel {
    ...
    factory BlackJackInvestModel.fromJson(Map<String, dynamic> json) => BlackJackInvestModel(
        remark: json["remark"],
        status: json["status"],
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        dealerCardImg: json["dealerCardImg"] == null ? [] : List<String>.from(json["dealerCardImg"]!.map((x) => x.toString())),
        cardImg: json["cardImg"] == null ? [] : List<String>.from(json["cardImg"]!.map((x) => x.toString())),
        gameLog: json["game_log"] == null ? null : GameLog.fromJson(json["game_log"]),
        balance: json["balance"].toString(),
        card: json["card"] == null ? [] : List<String>.from(json["card"]!.map((x) => x.toString())),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "dealerCardImg": dealerCardImg == null ? [] : List<dynamic>.from(dealerCardImg!.map((x) => x)),
        "cardImg": cardImg == null ? [] : List<dynamic>.from(cardImg!.map((x) => x)),
