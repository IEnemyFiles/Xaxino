...
MinesInvestModel minesInvestModelFromJson(String str) => MinesInvestModel.fromJson(json.decode(str));

String minesInvestModelToJson(MinesInvestModel data) => json.encode(data.toJson());
...
class MinesInvestModel {
    ...
    factory MinesInvestModel.fromJson(Map<String, dynamic> json) => MinesInvestModel(
        remark: json["remark"],
        status: json["status"],
