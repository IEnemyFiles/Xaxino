...
PoolNumbeSubmitAnsModel poolNumbeSubmitAnsModelFromJson(String str) => PoolNumbeSubmitAnsModel.fromJson(json.decode(str));

String poolNumbeSubmitAnsModelToJson(PoolNumbeSubmitAnsModel data) => json.encode(data.toJson());
...
class PoolNumbeSubmitAnsModel {
    ...
    factory PoolNumbeSubmitAnsModel.fromJson(Map<String, dynamic> json) => PoolNumbeSubmitAnsModel(
        remark: json["remark"],
        status: json["status"],
