...
RouletteDataModel rouletteDataModelFromJson(String str) => RouletteDataModel.fromJson(json.decode(str));

String rouletteDataModelToJson(RouletteDataModel data) => json.encode(data.toJson());
...
class RouletteDataModel {
    ...
    factory RouletteDataModel.fromJson(Map<String, dynamic> json) => RouletteDataModel(
        remark: json["remark"],
        status: json["status"],
