...
SlotNumberSubmitAnsModel slotNumberSubmitAnsModelFromJson(String str) => SlotNumberSubmitAnsModel.fromJson(json.decode(str));

String slotNumberSubmitAnsModelToJson(SlotNumberSubmitAnsModel data) => json.encode(data.toJson());
...
class SlotNumberSubmitAnsModel {
    ...
    factory SlotNumberSubmitAnsModel.fromJson(Map<String, dynamic> json) => SlotNumberSubmitAnsModel(
        remark: json["remark"],
        status: json["status"],
...
factory Data.fromJson(Map<String, dynamic> json) => Data(
  ...
  number: json["number"] == null ? [] : List<String>.from(json["number"].map((x) => x.toString())),
