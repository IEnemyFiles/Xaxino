...
MinesGameInfoModel minesGameInfoModelFromJson(String str) => MinesGameInfoModel.fromJson(json.decode(str));

String minesGameInfoModelToJson(MinesGameInfoModel data) => json.encode(data.toJson());
...
class MinesGameInfoModel {
    ...
    factory MinesGameInfoModel.fromJson(Map<String, dynamic> json) => MinesGameInfoModel(
        remark: json["remark"],
        status: json["status"],
