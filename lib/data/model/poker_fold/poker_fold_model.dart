...
PokerFoldModel PokerFoldModelFromJson(String str) => PokerFoldModel.fromJson(json.decode(str));
...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        sound: json["sound"],
        rank: json["rank"],
        result: json["result"] == null ? [] : List<String>.from(json["result"]!.map((x) => x.toString())),
        path: json["path"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "sound": sound,
        "rank": rank,
        "result": result == null ? [] : List<dynamic>.from(result!.map((x) => x.toString())),
        "path": path,
        "balance": balance,
    };
}
