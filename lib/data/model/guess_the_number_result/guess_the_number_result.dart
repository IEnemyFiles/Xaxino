...
GuessTheNumberResultModel guessTheNumberResultModelFromJson(String str) => GuessTheNumberResultModel.fromJson(json.decode(str));

String guessTheNumberResultModelToJson(GuessTheNumberResultModel data) => json.encode(data.toJson());
...
class GuessTheNumberResultModel {
    ...
    factory GuessTheNumberResultModel.fromJson(Map<String, dynamic> json) => GuessTheNumberResultModel(
        remark: json["remark"],
        status: json["status"],
