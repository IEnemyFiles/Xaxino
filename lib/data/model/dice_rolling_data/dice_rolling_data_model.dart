...
DiceRollingDataModel diceRollingDataModelFromJson(String str) => DiceRollingDataModel.fromJson(json.decode(str));

String diceRollingDataModelToJson(DiceRollingDataModel data) => json.encode(data.toJson());
...
class DiceRollingDataModel {
    ...
    factory DiceRollingDataModel.fromJson(Map<String, dynamic> json) => DiceRollingDataModel(
        remark: json["remark"],
        status: json["status"],
...
class Datas {
    ...
    factory Datas.fromJson(Map<String, dynamic> json) => Datas(
       game: json["game"] == null ? null : Game.fromJson(json["game"]),
        ...
        winPercent: json["winPercent"] == null ? [] : List<dynamic>.from(json["winPercent"]!.map((x) => x)),
        gesBon: json["gesBon"],
        pokerImg: json["pokerImg"],
        shortDesc: json["shortDesc"].toString(),
        cardFindingImgName: json["cardFindingImgName"] == null ? [] : List<String>.from(json["cardFindingImgName"]!.map((x) => x)),
    ...
    Map<String, dynamic> toJson() => {
       "game": game?.toJson(),
        ...
        "winChance": winChance,
        "winPercent": winPercent == null ? [] : List<dynamic>.from(winPercent!.map((x) => x.toString())),
        "gesBon": gesBon,
        "pokerImg": pokerImg,
        "shortDesc": shortDesc,
        "cardFindingImgName": cardFindingImgName == null ? [] : List<dynamic>.from(cardFindingImgName!.map((x) => x.toString())),
