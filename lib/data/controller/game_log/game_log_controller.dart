import 'dart:convert';
import 'package:xaxino/data/model/game_log/game_log_model.dart';
...
class GameLogController extends GetxController {
  ...
  gameLogData() async {
    ...
    if (response.statusCode == 200) {
      GameLogModel model = GameLogModel.fromJson(jsonDecode(response.responseJson));
