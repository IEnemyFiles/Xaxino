import 'dart:convert';
import 'package:xaxino/data/model/game_screen/game_screen_model.dart';
...
class AllGamesNavScreenController extends GetxController {
  ...
  allGamesInfo() async {
    ...
    if (model.statusCode == 200) {
      GameScreenModel responseModel = GameScreenModel.fromJson(jsonDecode(model.responseJson));
      ...
      if (responseModel.data?.games != null) {
        ...
        totalBalance = responseModel.data?.widget?.totalBalance.toString() ?? "";
      }
    } else {
