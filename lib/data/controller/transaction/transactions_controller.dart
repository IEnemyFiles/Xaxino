...
class TransactionsController extends GetxController {
  ...
  Future<void> loadTransaction() async {
    ...
    ResponseModel responseModel = await transactionRepo.getTransactionList(page, type: selectedTrxType.toLowerCase(), remark: selectedRemark.toLowerCase(), searchText: trxSearchText);
