...
import 'package:xaxino/view/packages/signin_with_linkdin/src/models/linkedin_config.dart';
...
import 'package:xaxino/data/model/auth/login/login_response_model.dart';
...
class LoginController extends GetxController {
  ...
  void checkAndGotoNextStep(LoginResponseModel responseModel, {bool isSocialLogin = false}) async {
    ...
    await loginRepo.apiClient.sharedPreferences.setString(SharedPreferenceHelper.fullNameKey, '$firstName $lastName');

    await loginRepo.apiClient.sharedPreferences.setBool(SharedPreferenceHelper.isSocialLoginKey, isSocialLogin);
