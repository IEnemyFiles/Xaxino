...
import 'package:xaxino/view/packages/signin_with_linkdin/signin_with_linkedin.dart';
...
import 'package:xaxino/data/model/country_model/country_model.dart';
...
import 'package:xaxino/data/model/model/error_model.dart';
...
class RegistrationController extends GetxController {
  ...
  bool remember = true;
  void checkAndGotoNextStep(RegistrationResponseModel responseModel, {bool isSocialLogin = false}) async {
    ...
    await registrationRepo.apiClient.sharedPreferences.setString(SharedPreferenceHelper.fullNameKey, '$firstName $lastName');

    await registrationRepo.apiClient.sharedPreferences.setBool(SharedPreferenceHelper.rememberMeKey, true);
    await registrationRepo.apiClient.sharedPreferences.setBool(SharedPreferenceHelper.isSocialLoginKey, isSocialLogin);
    ...
    await registrationRepo.apiClient.sharedPreferences.setString(SharedPreferenceHelper.lastNameKey, responseModel.data?.user?.lastname ?? '');
    ...
    if (isProfileCompleteEnable) {
      ...
      Get.offAndToNamed(
        RouteHelper.twoFactorVerificationScreen,
      );
    } else {
