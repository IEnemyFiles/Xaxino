...
import 'package:xaxino/data/model/profile/profile_post_model.dart';
...
import 'package:xaxino/data/model/profile/profile_response_model.dart';
import 'package:xaxino/data/model/user_post_model/user_post_model.dart';
...
class ProfileController extends GetxController {
  ...
  void loadData(ProfileResponseModel? model) {
    ...
    profileRepo.apiClient.sharedPreferences.setString(SharedPreferenceHelper.fullNameKey, '$firstName $lastName');

    profileRepo.apiClient.sharedPreferences.setString(SharedPreferenceHelper.userNameKey, '${model?.data?.user?.username}');
    profileRepo.apiClient.sharedPreferences.setString(SharedPreferenceHelper.lastNameKey, '${model?.data?.user?.lastname}');
