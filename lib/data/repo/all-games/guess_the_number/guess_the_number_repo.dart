...
class GuessTheNumberRepo {
  ...
  Future<ResponseModel> submitAnswer(String invest, String choose) async {
    ...
    Map<String, String> map = {'invest': invest.toString(), 'number': chooseBet.toString()};
    String url = '${UrlContainer.baseUrl}${UrlContainer.numberGuessingSubmitAnswer}';
  ...
  Future<ResponseModel> getAnswer(String gameID, String choose) async {
    Map<String, String> map = {'game_id': gameID.toString(), 'number': choose.toString()};
