...
class MyUtils {
  static splashScreen() {
  SystemChrome.setSystemUIOverlayStyle(const SystemUiOverlayStyle(statusBarColor: MyColor.topColor, statusBarIconBrightness: Brightness.light, systemNavigationBarColor: MyColor.topColor, systemNavigationBarIconBrightness: Brightness.dark));
  }
