import 'package:xaxino/view/components/bottom-nav-bar/bottom_nav_bar.dart';
import 'package:xaxino/view/screens/Profile/profile_screen.dart';
import 'package:xaxino/view/screens/account/change-password/change_password_screen.dart';
import 'package:xaxino/view/screens/all-games/black_jack/black_jack_screen.dart';
import 'package:xaxino/view/screens/all-games/card_finding/card_finding_screen.dart';
import 'package:xaxino/view/screens/all-games/dice_rolling/dice_rolling_screen.dart';
import 'package:xaxino/view/screens/all-games/guess_the_number/guess_the_number_screen.dart';
import 'package:xaxino/view/screens/all-games/head_tail/head_tail_screen.dart';
import 'package:xaxino/view/screens/all-games/keno/keno_screen.dart';
import 'package:xaxino/view/screens/all-games/mines/mines_screen.dart';
import 'package:xaxino/view/screens/all-games/play_casino_dice/play_casino_dice_screen.dart';
import 'package:xaxino/view/screens/all-games/poker/poker_screen.dart';
import 'package:xaxino/view/screens/all-games/rock_paper_scissors/rock_paper_scissors_screen.dart';
import 'package:xaxino/view/screens/all-games/roulette/roulette_screen.dart';
import 'package:xaxino/view/screens/all-games/slot_machine/play_number_slot_screen.dart';
import 'package:xaxino/view/screens/all-games/spin_wheel/spin_wheel_screen.dart';
import 'package:xaxino/view/screens/auth/email_verification_page/email_verification_screen.dart';
import 'package:xaxino/view/screens/auth/forget_password/forget_password/forget_password.dart';
import 'package:xaxino/view/screens/auth/forget_password/reset_password/reset_password_screen.dart';
import 'package:xaxino/view/screens/auth/forget_password/verify_forget_password/verify_forget_password_screen.dart';
import 'package:xaxino/view/screens/auth/login/login_screen.dart';
import 'package:xaxino/view/screens/auth/profile_complete/profile_complete_screen.dart';
import 'package:xaxino/view/screens/auth/registration/registration_screen.dart';
import 'package:xaxino/view/screens/auth/registration/two_factor/two_factor_setup_screen/two_factor_setup_screen.dart';
import 'package:xaxino/view/screens/auth/registration/two_factor/two_factor_verification_screen/two_factor_verification_screen.dart';
import 'package:xaxino/view/screens/auth/sms_verification_page/sms_verification_screen.dart';
import 'package:xaxino/view/screens/bottom_nav_section/home/home_screen.dart';
import 'package:xaxino/view/screens/deposits/deposit_webview/my_webview_screen.dart';
import 'package:xaxino/view/screens/deposits/deposits_screen.dart';
import 'package:xaxino/view/screens/deposits/new_deposit/new_deposit_screen.dart';
import 'package:xaxino/view/screens/edit_profile/edit_profile_screen.dart';
import 'package:xaxino/view/screens/all-games/pool_number/pool_number_screen.dart';
import 'package:xaxino/view/screens/faq/faq_screen.dart';
import 'package:xaxino/view/screens/game_log/game_log_screen.dart';
import 'package:xaxino/view/screens/kyc/kyc.dart';
import 'package:xaxino/view/screens/privacy_policy/privacy_policy_screen.dart';
import 'package:xaxino/view/screens/refferal/refferal_screen.dart';
import 'package:xaxino/view/screens/splash/splash_screen.dart';
import 'package:xaxino/view/screens/transaction/transactions_screen.dart';
...
static const String twoFactorVerificationScreen = "/two-factor-verification-screen";
...
static const String homeScreen                  = "/home_screen";
  ...
  List<GetPage> routes = [
   GetPage(name: depositWebViewScreen,         page: () => MyWebViewScreen(redirectUrl: Get.arguments)),
    ...
    GetPage(name: rockPaperScissorsScreen,      page: () => const RockPaperScissorsScreen()),
    GetPage(name: rouletteScreen,               page: () => const RouletteScreen()),
    GetPage(name: guessTheNumberScreen,         page: () => const GuessTheNumberScreen()),
    ...
    GetPage(name: poolNumberScreen,             page: ()
    => const PoolNumberScreen()),
    GetPage(name: playCasinoDiceScreen,         page: () => const PlayCasinoDiceScreen()),
