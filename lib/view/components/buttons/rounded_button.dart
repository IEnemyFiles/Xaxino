  ...
  Widget build(BuildContext context) {
    ...
    InkWell(
      ...
      child: Container(
          ...
          child: Center(child: Text(text.tr,style:regularDefault.copyWith(color: isColorChange ? textColor : MyColor.getPrimaryButtonTextColor(), fontSize: 16, fontWeight: FontWeight.w500)))),
    ):
    isOutlined? Material(
      child: InkWell(
        onTap: press,
        ...
        child: Container(
            ...
            child: Center(child: Text(text.tr,style:TextStyle(color: isColorChange ? textColor : MyColor.getPrimaryButtonTextColor(), fontSize: 16, fontWeight: FontWeight.w500)))),
      ),
    ): SizedBox(
      width: size.width * width,
      child: ClipRRect(
