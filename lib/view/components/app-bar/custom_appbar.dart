...
import 'package:xaxino/view/components/dialog/exit_dialog.dart';
...
class _CustomAppBarState extends State<CustomAppBar> {
  ...
  Widget build(BuildContext context) {
    return widget.isShowBackBtn?AppBar(
      ...
      actions: [
        widget.isShowActionBtn?InkWell(onTap: (){Get.toNamed(RouteHelper.headAndTailScreen)?.then((value){
          setState(() {
