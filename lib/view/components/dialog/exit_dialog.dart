...
showExitDialog(BuildContext context){
    ...
    AwesomeDialog(
      padding: const EdgeInsets.symmetric(vertical: Dimensions.space10,horizontal: 5),
      context: context,
      ...
      titleTextStyle: regularLarge.copyWith(color: MyColor.colorWhite, fontWeight: FontWeight.w600),
      showCloseIcon: false,
