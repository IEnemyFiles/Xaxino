  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(body.tr,style: isCharge?regularDefault.copyWith(fontFamily:"Inter",color: MyColor.redCancelTextColor):regularDefault.copyWith(fontFamily:"Inter",color: MyColor.textColor2),overflow: TextOverflow.ellipsis,)
      ],
    );
  }
}
