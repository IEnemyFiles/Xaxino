  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(body.tr,style: lastTextRed?regularDefault.copyWith(fontFamily:"Inter",fontSize:isSmallFont?Dimensions.fontSmall:Dimensions.fontDefault,color: MyColor.redCancelTextColor):regularDefault.copyWith(fontFamily:"Inter",color: MyColor.textColor2,fontSize:isSmallFont?Dimensions.fontSmall:Dimensions.fontDefault,),overflow: TextOverflow.ellipsis,)
      ],
    );
  }
}
