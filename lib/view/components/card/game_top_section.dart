...
class GameTopSection extends StatefulWidget {
  ...
  const GameTopSection({super.key, required this.name, required this.instruction});
...
class _GameTopSectionState extends State<GameTopSection> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: MyColor.secondaryPrimaryColor, border: Border.all(color: MyColor.navBarActiveButtonColor), borderRadius: BorderRadius.circular(50)),
      child: Row(
        children: [
          Expanded(
            child: Align(
              ...
              child: InkWell(
                  ...
                  child: SvgPicture.asset(MyImages.roundedBackWardSVG,height: 30,)),
            ),
          ),
          Expanded(
            flex: 3,
            child: Text(
              widget.name.tr ,
              style: semiBoldLarge.copyWith(color: MyColor.navBarActiveButtonColor),
                        ...
                        children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: semiBoldLarge.copyWith(fontFamily: 'Inter'),
                                ),
                                InkWell(
                                    onTap: () {
                                      Get.back();
                          ...
                          Padding(
                            ...
                            child: Html(
                              ...
                              style: {
                                "body": Style(color: MyColor.colorWhite),
                              },
                            ),
                          ),
                        ],
