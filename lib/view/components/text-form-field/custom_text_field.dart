...
import 'package:xaxino/view/components/text/label_text_with_instructions.dart';
...
import 'package:xaxino/view/components/text/label_text.dart';
    ...
    return widget.needOutlineBorder
        ? widget.animatedLabel
            ? TextFormField(
                ...
                style: widget.hasLabelTextSize ? TextStyle(fontSize: 20, color: MyColor.textColor2) : regularDefault.copyWith(color: MyColor.getTextColor(), fontFamily: 'Inter'),
                ...
                decoration: InputDecoration(
                  ...
                  hintText: widget.hintText ?? '', // Set to empty string if null
                  hintStyle: regularSmall.copyWith(fontSize: Dimensions.fontDefault, color: MyColor.getHintTextColor().withOpacity(0.7), fontFamily: 'Inter'),
                  floatingLabelBehavior: FloatingLabelBehavior.never,
                  contentPadding: const EdgeInsets.only(top: 5, left: 15, right: 15, bottom: 5),
                  fillColor: widget.fillColor,
                  filled: true,
                  border: OutlineInputBorder(borderSide: BorderSide(width: 0.5, color: widget.disableBorderColor), borderRadius: BorderRadius.circular(Dimensions.defaultRadius)),
                  ...
                  enabledBorder: OutlineInputBorder(borderSide: BorderSide(width: 0.5, color: widget.disableBorderColor), borderRadius: BorderRadius.circular(Dimensions.defaultRadius)),
                  suffixIcon: SizedBox(
                    width: 65,
                    child: Row(
                        ...
                        if (widget.isSuffixContainer)
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                widget.currrency ?? "",
                                style: semiBoldDefault.copyWith(fontFamily: 'Inter'),
                              ),
                            ),
                          ),
            ...
            : Column(
                ...
                LabelTextInstruction(
                  ...
                  TextFormField(
                    maxLines: widget.maxLines,
                    readOnly: widget.readOnly,
                    style: regularDefault.copyWith(color: MyColor.getTextColor(), fontFamily: 'Inter'),
                    maxLength: widget.maxLength,
                    cursorColor: MyColor.getTextColor(),
                    controller: widget.controller,
                    autofocus: false,
                    ...
                    decoration: InputDecoration(
                      ...
                      fillColor: widget.fillColor,
                      filled: true,
                      border: OutlineInputBorder(borderSide: const BorderSide(width: 0.5, color: MyColor.bottomColor), borderRadius: BorderRadius.circular(widget.borderRadious)),
                      focusedBorder: OutlineInputBorder(borderSide: const BorderSide(width: 0.5, color: MyColor.bottomColor), borderRadius: BorderRadius.circular(widget.borderRadious)),
                      enabledBorder: OutlineInputBorder(borderSide: const BorderSide(width: 0.5, color: MyColor.bottomColor), borderRadius: BorderRadius.circular(widget.borderRadious)),
        ...
        : TextFormField(
            ...
            decoration: InputDecoration(
              ...
              suffixIcon: widget.isShowSuffixIcon
                  ? widget.isPassword
                      ? IconButton(icon: Icon(widget.isPassword ? Icons.visibility_off : Icons.visibility, color: MyColor.hintTextColor, size: 20), onPressed: _toggle)
                      : widget.isIcon
                          ? IconButton(
                              onPressed: widget.onSuffixTap,
                              icon: Icon(
