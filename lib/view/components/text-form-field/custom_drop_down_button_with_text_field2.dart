        ...
        widget.isUnderLined?SizedBox(
          ...
          child: DropdownButtonFormField(
            ...
            decoration: InputDecoration(
              ...
              border: const UnderlineInputBorder(borderSide: BorderSide(color: MyColor.borderColor,width: .5)),
              focusedBorder: const UnderlineInputBorder(borderSide: BorderSide(color: MyColor.primaryColor,width: .5)),
              enabledBorder: const UnderlineInputBorder(borderSide: BorderSide(color: MyColor.borderColor,width: .5)),
            ),
            isExpanded: true,
          ...
          child: DropdownButtonFormField(
            ...
            decoration: InputDecoration(
              ...
              border: OutlineInputBorder(
                ...
                borderSide: const BorderSide(color: MyColor.borderColor, width: .5),
              ),
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(widget.radius),
                borderSide: const BorderSide(color: MyColor.primaryColor, width: .5),
              ),
