...
import 'package:xaxino/view/components/buttons/custom_round_border_shape.dart';
                  ...
                  child: Column(
                    children: [
                      ...
                      widget.isNoInternet
                          ...
                          : Text(
                              widget.message2,
                              style: regularDefault.copyWith(fontFamily: "Inter", color: MyColor.colorWhite, fontSize: Dimensions.fontLarge),
                              textAlign: TextAlign.center,
                            ),
                      widget.isNoInternet
                          ? const SizedBox(
                    ...
                    widget.hasActionButton?  RoundedButton(
