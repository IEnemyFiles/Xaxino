...
import 'package:xaxino/view/screens/bottom_nav_section/home/widget/trending_games_cards.dart';
                            ...
                            child: GridView.builder(
                              padding:const EdgeInsets.all(0),
                                ...
                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                  crossAxisCount: controller.trendingGamesList.length <= 2 ? 2 : 4,
                                  crossAxisSpacing: 10,
                                  childAspectRatio: isPortrait ? (controller.trendingGamesList.length <= 2 ? 1.4 : 1) : 1.6,
                                ),
                                itemBuilder: (BuildContext context, int index) {
                                  var alias = controller.trendingGamesList[index].alias;
                                  controller.trendingGamesLength=controller.trendingGamesList.length;
                                  return GestureDetector(onTap: () {
                                      ...
                                      child: TrendingGamesCard(myImage: UrlContainer.dashboardImage + controller.trendingGamesList[index].image.toString()));
                                }),
                          ),
                        ],
                      ),
