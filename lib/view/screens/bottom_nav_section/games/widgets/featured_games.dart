...
import 'package:xaxino/data/controller/all-games_nav_screen/all_games_controller.dart';
...
class AllGamesFeaturedGamesSection extends StatefulWidget {
  ...
  @override
  State<AllGamesFeaturedGamesSection> createState() => _AllGamesFeaturedGamesSectionState();
}

class _AllGamesFeaturedGamesSectionState extends State<AllGamesFeaturedGamesSection> {
  @override
              ...
              children: [
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          border: Border.all(color: MyColor.navBarActiveButtonColor, width: .4),
                          borderRadius: BorderRadius.circular(Dimensions.space10),
                          image: DecorationImage(
                            image: NetworkImage(UrlContainer.dashboardImage + game.image.toString()),
                            fit: BoxFit.cover,
                          ),
                        ),
                        child: Column(
                                        ...
                                        child: Container(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: CustomNetworkImage(
                                              ...
                                              imageUrl: UrlContainer.dashboardImage + game.image.toString(),
                                              width: 200,
                                              height: 200,
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  ...
                                                  child: Container(
                                                    padding: const EdgeInsets.symmetric(vertical: Dimensions.space6, horizontal: Dimensions.space17),
                                                    decoration: BoxDecoration(color: MyColor.navBarActiveButtonColor, borderRadius: BorderRadius.circular(Dimensions.space4)),
                                                    child: Text(MyStrings.playNow.tr, style: semiBoldDefault.copyWith(fontFamily: 'Inter')),
                                                  ),
                                                )
                                              ],
                                            ),
                ...
                Center(
                  child: FittedBox(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: List.generate(controller.featuredGamesList.length, (index) {
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: controller.currentIndex == index ? MyColor.activeIndicatorColor : MyColor.inActiveIndicatorColor.withOpacity(.3),
                          ),
                        );
                      }),
                    ),
