...
import 'package:xaxino/data/model/game_screen/game_screen_model.dart'as prefix;
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AllGamesNavScreenController>(
        builder: (controller) => OrientationBuilder(builder: (context, orientation) {
              ...
              final List<prefix.Game> filteredGames = controller.filteredGames.isNotEmpty ? controller.filteredGames : controller.gamesList;
                                ...
                                Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: CustomNetworkImage(
                                              ...
                                              imageUrl:  UrlContainer.dashboardImage + filteredGames[index].image.toString(),
                                ...
                                Padding(
                                  ...
                                  child: Align(
                                    ...
                                    child: Column(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(filteredGames[index].name.toString().tr,
