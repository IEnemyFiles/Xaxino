...
import 'package:xaxino/data/repo/all-games/all_games_repo.dart';
...
import 'package:xaxino/view/screens/bottom_nav_section/games/widgets/all_games_section.dart';
import 'package:xaxino/view/screens/bottom_nav_section/games/widgets/featured_games.dart';
...
class _GamesScreenState extends State<GamesScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(AllGamesNavScreenController(allGanmesRepo: Get.find()));
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(MyStrings.games.tr, style: semiBoldExtraLarge.copyWith(color: MyColor.colorWhite))],
                              ),
                            ),
                            Padding(
