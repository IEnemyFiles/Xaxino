...
import 'package:xaxino/data/model/language/main_language_response_model.dart';
                ...
                onTap: ()async{
                  ...
                  if(response.statusCode == 200){
                    try{
                      ...
                      language['${widget.langList[index].code ?? ""}_${'US'}'] = json;

                      Get.clearTranslations();
                      Get.addTranslations(Messages(languages: language).keys);

                      Locale local = Locale(widget.langList[index].code??"",'US');
