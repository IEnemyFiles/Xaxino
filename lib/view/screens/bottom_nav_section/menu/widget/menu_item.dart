        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                Container(
                  height:Dimensions.space35, width: Dimensions.space35,
                  ...
                  CustomSvgPicture(image:
                    ...
                    height: Dimensions.space20, width: Dimensions.space17
                  ) :
                  Image.asset(
                    imageSrc,
                    color: MyColor.colorWhite,
                    height: Dimensions.space17, width: Dimensions.space17
                  ),
                ),
                const SizedBox(width: Dimensions.space15),
                Text(label.tr, style: regularDefault.copyWith(color: MyColor.colorWhite))
              ],
            ),
            Container(
              height: Dimensions.space30, width: Dimensions.space30,
              alignment: Alignment.center,
              decoration: const BoxDecoration(color: MyColor.transparentColor, shape: BoxShape.circle),
              child: const Icon(Icons.arrow_forward_ios_rounded, color: MyColor.colorWhite, size: 15),
            ),
          ],
        ),
      ),
