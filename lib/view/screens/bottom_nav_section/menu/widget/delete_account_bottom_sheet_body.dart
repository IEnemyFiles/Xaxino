      ...
      return LayoutBuilder(builder: (context, box) {
        ...
        return SingleChildScrollView(
          child: Container(
            ...
            decoration:const BoxDecoration(color: MyColor.bottomColor,borderRadius: BorderRadius.all(Radius.circular(10))),
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: mediumDefault.copyWith(color: MyColor.colorWhite, fontSize: Dimensions.fontLarge),
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: Dimensions.space25),
                Text(
                  MyStrings.deleteBottomSheetSubtitle.tr,
                  style: regularDefault.copyWith(color: MyColor.colorWhite.withOpacity(0.8), fontSize: Dimensions.fontLarge),
                  textAlign: TextAlign.center,
                ),
