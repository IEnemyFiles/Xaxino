...
class _WalletBalanceState extends State<WalletBalance> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WalletScreencontroller>(
        ...
        children: [
          Container(
            decoration: BoxDecoration(border: Border.all(color: MyColor.primaryButtonColor), color: MyColor.colorWhite, borderRadius: BorderRadius.circular(Dimensions.space12)),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(controller.defaultCurrency+
                            Converter.formatNumber(controller.totalWin,precision: 2),
                            style: semiBoldExtraLarge.copyWith(
                              color: MyColor.primaryButtonColor,
                            ))
                      ],
