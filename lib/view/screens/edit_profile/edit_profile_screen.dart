...
import 'package:xaxino/view/screens/edit_profile/widget/edit_profile_form.dart';
    ...
    return GetBuilder<ProfileController>(
      builder: (controller) => SafeArea(
        child: Scaffold(
          ...
          body: controller.isLoading ? const CustomLoader(loaderColor: MyColor.colorWhite,) : Stack(
            children: [
              Positioned(
                top: -10,
                child: Container(
