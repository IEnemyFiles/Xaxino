...
import 'package:xaxino/data/controller/auth/forget_password/reset_password_controller.dart';
...
import 'package:xaxino/view/components/text/header_text.dart';
import 'package:xaxino/view/components/will_pop_widget.dart';
import 'package:xaxino/view/screens/auth/registration/widget/validation_widget.dart';
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DefaultText(text: MyStrings.resetPassContent.tr, textAlign: TextAlign.start, fontSize: Dimensions.fontMediumLarge-1, textStyle: regularLargeInter.copyWith(color: MyColor.colorWhite)),
                    const SizedBox(height: Dimensions.space15),
                    Focus(
