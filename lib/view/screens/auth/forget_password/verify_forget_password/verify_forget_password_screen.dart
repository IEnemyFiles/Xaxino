...
import 'package:xaxino/data/controller/auth/forget_password/verify_password_controller.dart';
                      ...
                      child: Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(padding: const EdgeInsets.symmetric(horizontal: 25), child: DefaultText(text: '${MyStrings.verifyPasswordSubText.tr} : ${controller.getFormatedMail().tr}', textAlign: TextAlign.center, textStyle: regularDefaultInter.copyWith(color: MyColor.textColor), textColor: MyColor.textColor)),
                            const SizedBox(height: Dimensions.space40),
                            Padding(
                              padding: const EdgeInsets.symmetric(horizontal: Dimensions.space30),
                              child: PinCodeTextField(
                                appContext: context,
                                pastedTextStyle: regularDefaultInter.copyWith(color: MyColor.getPrimaryColor()),
                                length: 6,
