...
import 'package:xaxino/data/controller/auth/auth/sms_verification_controler.dart';
import 'package:xaxino/data/repo/auth/sms_email_verification_repo.dart';
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(padding: const EdgeInsets.symmetric(horizontal: 25), child: DefaultText(text: MyStrings.smsVerificationMsg.tr, textAlign: TextAlign.center, textStyle: regularLargeInter.copyWith(color: MyColor.getSecondaryTextColor()))),
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(MyStrings.didNotReceiveCode.tr, style: regularDefaultInter.copyWith(color: MyColor.getLabelTextColor())),
                              ...
                              controller.resendLoading
                                  ...
                                  : GestureDetector(
                                      ...
                                      child: Text(MyStrings.resendCode.tr, style: regularDefaultInter.copyWith(decoration: TextDecoration.underline, decorationColor: MyColor.getPrimaryColor(), color: MyColor.getPrimaryColor()))),
                            ],
                          )
                        ],
                      ),
