...
import 'package:xaxino/data/controller/auth/two_factor_controller.dart';
...
import 'package:xaxino/view/components/text/small_text.dart';
          ...
          child: Column(
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: MyColor.colorBgCard, borderRadius: BorderRadius.circular(10)),
                child: Column(
                  ...
                  children: [
                    Center(
                      child: Text(
                        ...
                        style: boldExtraLarge.copyWith(color: MyColor.colorWhite,fontFamily: "Inter"),
                      ),
                    ),
                    const CustomDivider(),
                    Center(
              ...
              Container(
                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Padding(
                      ...
                      child: SmallText(text: MyStrings.twoFactorMsg.tr, maxLine: 3, textAlign: TextAlign.center, textStyle: regularDefault.copyWith(color: MyColor.colorWhite,fontFamily: "Inter")),
                    ),
