...
import 'package:xaxino/view/components/bottom-sheet/bottom_sheet_header_row.dart';
import 'package:xaxino/view/components/bottom-sheet/custom_bottom_sheet.dart';
import 'package:xaxino/view/components/card/bottom_sheet_card.dart';
...
class CountryBottomSheet {
  ...
  static void countryBottomSheet(BuildContext context, ProfileCompleteController controller) {
    CustomBottomSheet(
        bgColor: MyColor.bottomColor,
        child: Container(
          height: MediaQuery.of(context).size.height * 1,
