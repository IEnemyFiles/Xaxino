...
import 'package:xaxino/data/controller/account/profile_complete_controller.dart';
...
import 'package:xaxino/view/screens/auth/registration/widget/country_bottom_sheet.dart';
import 'package:xaxino/view/screens/auth/registration/widget/country_text_field.dart';
...
class ProfileCompleteBodySection extends StatefulWidget {
  ...
  @override
  State<ProfileCompleteBodySection> createState() => _ProfileCompleteBodySectionState();
}

class _ProfileCompleteBodySectionState extends State<ProfileCompleteBodySection> {
  @override
  void initState() {
    ...
    return GetBuilder<ProfileCompleteController>(
      builder: (controller) => SingleChildScrollView(
        child: controller.isLoading
            ? const CustomLoader(loaderColor: MyColor.primaryColor, isFullScreen: true)
            : Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Center(
                          child: Image.asset(MyImages.appLogo, height: Dimensions.space50, width: Dimensions.space185),
                        ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (controller.countryData == '') ...[
                                CountryTextField(
                                  press: () {
                                    CountryBottomSheet.countryBottomSheet(context, controller);
                                  },
                                  text: controller.countryName == null ? MyStrings.selectACountry.tr : (controller.countryName)!.tr,
                                ),
                              ],
                              controller.countryData != '' ? const SizedBox() : const SizedBox(height: Dimensions.space25),
                              Visibility(
                                    ...
                                    children: [
                                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                        Container(
                                          ...
                                          decoration: BoxDecoration(color: MyColor.textFieldColor, borderRadius: BorderRadius.circular(Dimensions.defaultRadius), border: Border.all(color: controller.countryName == null ? MyColor.getTextFieldDisableBorder() : MyColor.getTextFieldEnableBorder(), width: 0.5)),
                                          child: Text(
