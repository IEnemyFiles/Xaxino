...
import 'package:xaxino/view/components/app-bar/action_button_icon_widget.dart';
...
import 'package:xaxino/view/screens/transaction/widget/bottom_sheet.dart';
import 'package:xaxino/view/screens/transaction/widget/filter_row_widget.dart';
                      ...
                      children: [
                        Visibility(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(color: MyColor.colorBgCard, borderRadius: BorderRadius.circular(Dimensions.defaultRadius),),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Row(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: FilterRowWidget(
                                                fromTrx: true,
                                                bgColor: MyColor.secondaryPrimaryColor,
                                  ...
                                  children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                  ...
                                                  enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: MyColor.inActiveIndicatorColor.withOpacity(.6), width: 0.5)),
                                                  focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: MyColor.inActiveIndicatorColor.withOpacity(.6), width: 0.5))),
                                            ),
                                          ),
                                        ],
                                      ),
                                    ...
                                    InkWell(
                                      ...
                                      child: Container(
                                        ...
                                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(4), color: MyColor.activeIndicatorColor),
                                        child: const Icon(Icons.search_outlined, color: MyColor.colorBlack, size: 18),
                                      ),
                                    )
                                  ],
                                ),
                       ...
                       controller.transactionList.isEmpty && controller.filterLoading == false
                                ? const Center(
                                    child: NoDataTile(title: MyStrings.notransectionFound),
                                  )
                                :  Expanded(
                                        ...
                                        child: ListView.separated(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            return ListTile(
                                              ...
                                              leading: Container(
                                                decoration: BoxDecoration(color: controller.transactionList[index].trxType.toString() == "+" ? MyColor.greenP : MyColor.redP, shape: BoxShape.circle),
                                                child: Padding(
                                                  padding: const EdgeInsets.all(Dimensions.space10),
                                                  child: SvgPicture.asset(
                                                    controller.transactionList[index].trxType.toString() == "+" ?MyImages.depositSvg : MyImages.withdraw,
                                              ...
                                              title: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    controller.transactionList[index].trx.toString(),
                                                    style: regularMediumLarge.copyWith(color: MyColor.colorWhite, fontFamily: 'Inter', overflow: TextOverflow.ellipsis,fontSize: Dimensions.fontMediumLarge -1),
                                                  ),
                                                ],
                                              ),
                                              subtitle: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    DateConverter.convertIsoToString(controller.transactionList[index].updatedAt.toString()),
                                              ...
                                              trailing: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                                                Text(
                                                  Converter.formatNumber(controller.transactionList[index].amount.toString()) + controller.currency,
                                                  style: regularMediumLarge.copyWith(color: MyColor.colorWhite, fontFamily: 'Inter'),
                                                ),
                                                Text(
                                                  controller.transactionList[index].remark.toString().replaceAll("_", " ").tr.capitalizeFirst??"",
                                                  style: regularDefault.copyWith(color: MyColor.subTitleTextColor, fontFamily: 'Inter'),
                                                ),
                                              ]),
                                            );
