  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<TransactionsController>(
      builder: (controller) => Container(
        ...
        padding: const EdgeInsets.symmetric(vertical: Dimensions.space15, horizontal: Dimensions.space14),
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(child: CardColumn(header: MyStrings.trxId, body: trxData)),
