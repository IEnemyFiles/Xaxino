              ...
              return Material(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ' ${callFrom ==2 ?
                      Converter.replaceUnderscoreWithSpace(list[index].capitalizeFirst??'').tr:
                      list[index].tr}',
                      style: regularDefault.copyWith(fontSize: Dimensions.fontDefault,color: MyColor.colorWhite),
                    ),
                  ),
                ),
              );
