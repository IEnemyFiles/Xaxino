...
import 'package:xaxino/data/controller/all_games/slot_machine/number_slot_controller.dart';
...
import 'package:xaxino/view/screens/all-games/slot_machine/widgets/card_slot.dart';
...
class _PlayNumberSlotScreenState extends State<PlayNumberSlotScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(PlayNumberSlotController(playNumberSlot: Get.find()));
    super.initState();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(decoration: BoxDecoration(color: MyColor.secondaryPrimaryColor, border: Border.all(color: MyColor.navBarActiveButtonColor), borderRadius: BorderRadius.circular(Dimensions.space8)), padding:const EdgeInsets.all(Dimensions.space10), width: double.infinity, child:const SlotMachinePage()),
                            ...
                            Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Image.asset(MyImages.info, color: MyColor.colorWhite, height: Dimensions.space18),
                                ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                     ...
                                     controller.levels.isNotEmpty? Text(
                                        ...
                                        style: regularDefault.copyWith(color: MyColor.inActiveIndicatorColor, fontFamily: "Inter"),
                                      ):const SizedBox(height: Dimensions.space15)
                                    ],
                                  ),
                                )
                        ...
                        RoundedButton(
                          ...
                          press: () {
                            if (controller.amountController.text.isNotEmpty) {
                              if (controller.enterNumberController.text.isNotEmpty) {
