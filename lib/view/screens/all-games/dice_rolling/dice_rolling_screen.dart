...
import 'package:xaxino/data/controller/all_games/dice_rolling_controller.dart';
...
import 'package:xaxino/view/screens/all-games/widgets/dice.dart';
...
class _DiceRollingScreenState extends State<DiceRollingScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(DiceRollingController(diceRollingRepo: Get.find()));
    super.initState();
    ...
    return Scaffold(
      body: GetBuilder<DiceRollingController>(
        builder: (controller) => Container(
          ...
          child:controller.isLoading?const CustomLoader(loaderColor: MyColor.colorWhite): SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      decoration: BoxDecoration(color: MyColor.secondaryPrimaryColor, border: Border.all(color: MyColor.navBarActiveButtonColor), borderRadius: BorderRadius.circular(Dimensions.space8)),
                      ...
                      child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return OptionSelectionContainer(
                              isSelected: controller.selectedDiceIndex == index,
