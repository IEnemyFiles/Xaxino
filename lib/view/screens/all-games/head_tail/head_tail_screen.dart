...
import 'package:xaxino/data/controller/all_games/head-tail/head_tail_controller.dart';
...
import 'package:xaxino/view/screens/all-games/head_tail/widgets/flip_animation.dart';
import 'package:xaxino/view/screens/all-games/head_tail/widgets/option_selection_section.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AvailableBalanceCard(curSymbol: controller.defaultCurrencySymbol, balance: controller.availableBalance.toString()),
                        Container(
                            ...
                            : RoundedButton(
                                ...
                                press: () {
                                  if (controller.amountController.text.isNotEmpty) {
                                   if (controller.isUserChoiseIsTail == true|| controller.isUserChoiseIsHead == true) {
                                      controller.submitInvestmentRequest();
                                   }else{
                                     CustomSnackBar.error(errorList: [MyStrings.theChooseFieldisRequired]);
                                   }
                                  } else {
