...
class AvailableBalanceCard extends StatelessWidget {
  ...
  const AvailableBalanceCard({super.key, required this.balance, required this.curSymbol});
        ...
        children: [
          Expanded(
            child: Align(
              ...
              child: SvgPicture.asset(   MyImages.totalInvestSvg,
                height: 35,),
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: regularSmall.copyWith(color: MyColor.colorWhite, fontFamily: 'Inter'),
                ),
                Text(
