...
import 'package:xaxino/view/screens/all-games/roulette/widget/custom_wheel.dart';
import 'package:xaxino/view/screens/all-games/widgets/bet_board.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: Dimensions.space10),
                  Container(margin: const EdgeInsets.symmetric(vertical: Dimensions.space10, horizontal: Dimensions.space10), padding: const EdgeInsets.symmetric(vertical: Dimensions.space6, horizontal: Dimensions.space50), width: double.infinity, decoration: BoxDecoration(color: MyColor.secondaryPrimaryColor, borderRadius: BorderRadius.circular(8)), child: const BetBoard()),
