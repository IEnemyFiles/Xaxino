...
import 'package:xaxino/core/utils/util.dart';
import 'package:xaxino/data/controller/all_games/keno/keno_screen_controller.dart';
...
import 'package:xaxino/view/screens/all-games/keno/widgets/keno_buttons.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        AvailableBalanceCard(balance: controller.availAbleBalance, curSymbol: controller.currencySym),
                        Column(
                          children: [
                            GridView.builder(
                                shrinkWrap: true,
                                ...
                                itemBuilder: (context, index) {
                                  return InkWell(
                                    onTap: () {
                                      if (!controller.kenoNumbers[index].isSelected) {
                                        if (controller.selectedCount < 10) {
                                            AudioPlayer().play(AssetSource(MyAudio.kenoTapAudio));
                                          controller.kenoNumbers[index].isSelected = true;
                                        } else {
                                          CustomSnackBar.error(errorList: [(MyStrings.maximumLimit)]);
                                        }
                                      }
                                    ...
                                    child: Container(
                                      margin: const EdgeInsets.all(Dimensions.space1),
                                      decoration: BoxDecoration(
                                          color: controller.kenoNumbers[index].isSelected
                                              ? MyColor.navBarActiveButtonColor
                                              : controller.kenoNumbers[index].isFromAdmin
                                                  ? MyColor.greenP
                                                  : MyColor.colorBgCard,
                                      ...
                                      child: Center(
                                          child: Text(
                                        controller.kenoNumbers[index].number.toString().tr,
                                ...
                                text: TextSpan(
                                  children: [
                                    TextSpan(
                                      ...
                                      style: regularLarge.copyWith(color: MyColor.colorWhite, fontFamily: "Inter"),
                                    ),
                                    TextSpan(
                                      text: MyStrings.tenNumbers.tr,
                                      style: regularLarge.copyWith(color: MyColor.navBarActiveButtonColor, fontFamily: "Inter"),
                                    ),
                                  ],
                                ),
                              ),
                            ...
                            : RoundedButton(
                                ...
                                press: () {
                                  ...
                                  if (controller.amountController.text.isNotEmpty) {
                                    if (controller.selectedNumbers.length == 10) {
                                      controller.submitInvestmentRequest();
                                    } else {
                                      CustomSnackBar.error(errorList: [MyStrings.youHaveToSelectMinimumTenNumber]);
                                    }
                                  } else {
                                    CustomSnackBar.error(errorList: [MyStrings.enterInvestmentAmount]);
                                  }
                                }),
                          Container(
                          ...
                          child: Column(
                            children: [
                              Text(
                                ...
                                style: semiBoldOverLarge.copyWith(color: MyColor.colorWhite, fontFamily: "Inter"),
                              ),
                              RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: MyStrings.numberThatAreOnYourScratchOffAndThenClick.tr,
                                      style: regularLarge.copyWith(color: MyColor.colorWhite, fontFamily: "Inter"),
                                    ),
                                    TextSpan(
                                      text: " \"${MyStrings.playnow.tr}\" ",
                                      style: semiBoldMediumLarge.copyWith(color: MyColor.navBarActiveButtonColor, fontFamily: "Inter"),
                                    ),
                                    TextSpan(
                                      text: MyStrings.buttonToSeeIfYouAreAWinner.tr,
                                      style: regularLarge.copyWith(color: MyColor.colorWhite, fontFamily: "Inter"),
                                    ),
                                  ],
                                ),
