...
class OptionSelectionContainer extends StatelessWidget {
  ...
  const OptionSelectionContainer({Key? key, required this.images, this.onTap, this.isSelected = false}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        padding:const EdgeInsets.symmetric(horizontal: Dimensions.space6, vertical: Dimensions.space10),
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            width: 2,
            color: isSelected ? MyColor.navBarActiveButtonColor: MyColor.colorBorder ),
        ),
