...
class MinimumMaximumBonusSection extends StatelessWidget {
  ...
  const MinimumMaximumBonusSection({super.key, required this.minimum, required this.maximum, required this.winAmount, required this.haswinAmount, this.bonusAmount = "", this.currencySym = "",this.showMinimumAndMaximum=true,this.hasBonusAmount=true});
              ...
              children: [
               showMinimumAndMaximum? Text(
                ...
                haswinAmount
                    ...
                    : bonusAmount!="" && hasBonusAmount? Text(
