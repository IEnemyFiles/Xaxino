...
class WinnerDialog extends StatefulWidget {
  ...
  const WinnerDialog({super.key, required this.result, this.isShowResult = true,this.iskenoResult=false,this.adminSelectedNumber=''});

  @override
  State<WinnerDialog> createState() => _WinnerDialogState();
}

class _WinnerDialogState extends State<WinnerDialog> with TickerProviderStateMixin {
  late final AnimationController _controller;

  @override
  void initState() {
    _controller = AnimationController(vsync: this, duration: const Duration(seconds: 650));
        ...
        children: [
          Column(
            ...
            children: [
              ...
              widget.isShowResult || widget.iskenoResult? const Divider(
                thickness: 0.3,
              ) : const SizedBox.shrink(),
              widget.isShowResult
                  ? Text(
                     widget.result!=""? '${MyStrings.theResultIs.tr} ${widget.result}':"",
