...
import 'package:xaxino/data/controller/all_games/card_finding/card_finding_controller.dart';
...
import 'package:xaxino/view/screens/all-games/card_finding/widgets/card_section.dart';
...
import 'package:xaxino/view/screens/all-games/widgets/option_selection_cotainer.dart';
...
class _CardFindingScreenState extends State<CardFindingScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(CardFindingController(cardFindingRepo: Get.find()));
    super.initState();
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(decoration: BoxDecoration(color: MyColor.secondaryPrimaryColor, border: Border.all(color: MyColor.navBarActiveButtonColor), borderRadius: BorderRadius.circular(Dimensions.space8)), padding: const EdgeInsets.all(Dimensions.space10), width: double.infinity, child: const CardSection()),
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(color: MyColor.secondaryPrimaryColor, borderRadius: BorderRadius.circular(Dimensions.space8)),
                      child: GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return OptionSelectionContainer(
                              isSelected: controller.selectedCardIndex == index,
                          ...
                          press: () {
                            if (controller.amountController.text.isNotEmpty) {
                              if (controller.selectedCardIndex != -1) {
                                ...
                                CustomSnackBar.error(errorList: [MyStrings.selecABet]);
                              }
                            } else {
