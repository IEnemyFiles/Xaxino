...
import 'package:xaxino/data/controller/all_games/mines/mines_screen_controller.dart';
                      ...
                      children: [
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      if (controller.amountController.text.isEmpty) {
                                        ...
                                        if (controller.minesController.text.isEmpty) {
                                          CustomSnackBar.error(errorList: [MyStrings.selectNumberofMines]);
                                        } else {
                                         if (!controller.startMine) {
                                             CustomSnackBar.error(errorList: [MyStrings.investFirst]);
                                         }else{
                                    ...
                                    child: Container(
                                      ...
                                      child: Image.asset(
                                        controller.mines[index].tapped ? controller.mines[index].imagePath : MyImages.treasureBoxOff,
                                      ),
                                    ),
                                  );
                                },
                        ...
                        controller.cashOutAvailable
                            ...
                            : Container(
                                ...
                                padding: const EdgeInsets.symmetric(vertical: Dimensions.space6, horizontal: Dimensions.space10),
                                width: double.infinity,
                                decoration: BoxDecoration(color: MyColor.secondaryPrimaryColor, borderRadius: BorderRadius.circular(8)),
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(MyStrings.enterNumberofMines.tr, style: regularDefault.copyWith(color: MyColor.colorWhite, fontFamily: "Inter")),
                                    const SizedBox(height: Dimensions.space5),
                                    CustomTextField(
                                      animatedLabel: true,
                                      borderColor: MyColor.textFieldBorder,
                        ...
                        controller.isSubmitted
                            ...
                            : RoundedButton(
                                ...
                                verticalPadding: 15,
                                cornerRadius: 8,
                                color: controller.cashOutAvailable ? MyColor.greenP : MyColor.primaryButtonColor,
                                text: controller.cashOutAvailable ? MyStrings.cashOut : MyStrings.playNow,
                                press: () {
                                  if (controller.amountController.text.isNotEmpty) {
                                    if (controller.minesController.text.isNotEmpty) {
                                      AudioPlayer().play(AssetSource(MyAudio.clickAudio));
                                      controller.cashOutAvailable ? controller.cashOut() : controller.submitInvestmentRequest();
                                    } else {
                                      CustomSnackBar.error(errorList: [MyStrings.selectNumberofMines]);
                                    }
                                  } else {
