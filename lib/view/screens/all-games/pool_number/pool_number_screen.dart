...
import 'package:xaxino/data/controller/all_games/pool_number/pool_number_controller.dart';
...
import 'package:xaxino/view/screens/all-games/pool_number/widgets/ball_animation_widget.dart';
...
class _PoolNumberScreenState extends State<PoolNumberScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(PoolNumberController(poolNumberRepo: Get.find()));
    super.initState();
