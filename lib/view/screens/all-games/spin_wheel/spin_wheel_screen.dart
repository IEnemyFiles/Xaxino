...
import 'package:xaxino/data/controller/all_games/spin_wheel/spin_wheel_controller.dart';
...
import 'package:xaxino/view/screens/all-games/spin_wheel/widgets/select_bet_buttons.dart';
import 'package:xaxino/view/screens/all-games/spin_wheel/widgets/spin_wheel.dart';
              ...
              child: Column(
                ...
                children: [
                 ...
                 AvailableBalanceCard(balance: controller.availAbleBalance, curSymbol: controller.defaultCurrencySymbol),
                  ...
                  const SizedBox(height: Dimensions.space10),
                  Container(
                      margin: const EdgeInsets.symmetric(vertical: Dimensions.space10, horizontal: Dimensions.space3),
                      ...
                      : RoundedButton(
                          ...
                          press: () {
                            if (controller.amountController.text.isNotEmpty) {
                             if (controller.isRed == true || controller.isBlue == true) {
                                controller.submitInvestmentRequest();
                              controller.play();
                             } else {
                                CustomSnackBar.error(errorList: [MyStrings.chooseFieldidRequired]);
                             }
                            } else {
