...
class _SpinWheelState extends State<SpinWheel> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        GetBuilder<SpinWheelControllers>(builder: (controller) {
                            ...
                            child: FortuneWheel(
                              ...
                              items: List.generate(
                                ...
                                (index) => FortuneItem(
                                  ...
                                  style: FortuneItemStyle(color: index.isEven ?  MyColor.redColor : MyColor.blueColor, borderColor: MyColor.transparentColor, textStyle: regularSmall),
                                ),
                              ),
                              onAnimationEnd: () {
