...
class _RockPaperScissorsScreenState extends State<RockPaperScissorsScreen> {
  ...
  void initState() {
    ...
    final controller = Get.put(RockPaperScissorsController(rockPaperScissorsRepo: Get.find()));
    super.initState();
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Visibility(
                                  visible: controller.showResult,
                                  child: Image.asset(
                                    controller.rockScissorPaperImages[controller.userChoice == Choice.rock
                                        ? 0
                        ...
                        child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return OptionSelectionContainer(
                                  isSelected: controller.userChoice != null && controller.userChoice!.index == index,
                                  images: controller.rockScissorPaperImages[index],
                                  onTap: () {
                              ...
                              press: () {
                                ...
                                if (controller.amountController.text.isNotEmpty) {
                                  if (controller.userChoice != null) {
                                    ...
                                    CustomSnackBar.error(errorList: [MyStrings.selectYourChoice]);
                                  }
                                } else {
