...
import 'package:xaxino/data/controller/all_games/poker/poker_controller.dart';
...
import 'package:xaxino/view/screens/all-games/black_jack/widgets/button.dart';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GameTopSection(name: controller.name, instruction: controller.instruction),
                            ...
                            return Row(
                              children: [
                                CustomNetworkImage(
                                  ...
                                  imageUrl: "${UrlContainer.pokerImage}${controller.pokerImg[index]}",
                                  width: 200,
                                  height: 200,
                              ...
                              controller.gesBon[index].isNotEmpty? Text(MyUtils.getIntoSign() + controller.gesBon[index].replaceAll(".00", "").tr  + MyUtils.getPercentSign(), style: regularLarge.copyWith(color: MyColor.colorWhite)):const SizedBox(),
                              ],
                            );
                          },
                        ),
                                ...
                                GridView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Container(
                                        ...
                                        child: controller.pokerBackCards[index].isNetworkImage
                                            ? 
                                              CustomNetworkImage(
                                              key: ValueKey("${controller.pokerBackCards[index]}"),
                                              imageUrl: "${UrlContainer.blackJackCardsImage}${controller.pokerBackCards[index].imagePath}.png",
                                              width: 200,
                                              height: 200,
                                              loaderColor: MyColor.activeIndicatorColor,
                                              placeholder: Image.asset(MyImages.placeHolderImage),
                                            ...
                                            : Image.asset(
                                                controller.pokerBackCards[index].imagePath,
                        ...
                        const SizedBox(height: Dimensions.space20),
                        controller.isInvested ? const SizedBox()
                            : Container(
