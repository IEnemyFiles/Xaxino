...
import 'package:xaxino/data/model/withdraw/withdraw_method_response_model.dart';
      ...
      builder: (controller) {
        return  Container(
          ...
          child: Scaffold(
            ...
            appBar: CustomAppBar(title: MyStrings.addWithdraw.tr,bgColor: MyColor.bottomColor,) ,
                ...
                child: Column(
                  ...
                  children: [
                    CustomDropDownTextField2(
                      ...
                      items: controller.withdrawMethodList.map((WithdrawMethod method) {
                        return DropdownMenuItem<WithdrawMethod>(
                          ...
                          child: Text((method.name??'').tr, style: regularDefault.copyWith(color: MyColor.getTextColor(),fontFamily: "Inter")),
                        );
                      }).toList(),
                    ),
                   ...
                   Visibility(
                       ...
                       CustomDropDownTextField2(
                         ...
                         items: controller.authorizationList.map((String value) {
                           return DropdownMenuItem<String>(
                             value: value,
                             child: Text((value.toString()).tr, style: regularDefault.copyWith(color: MyColor.colorWhite)),
                           );
                         }).toList(),
                       ),
                     ],
                    ...
                    controller.submitLoading? const RoundedLoadingBtn( color: MyColor.primaryButtonColor,):
                    RoundedButton(
