...
import 'package:xaxino/data/controller/withdraw/withdraw_history_controller.dart';
import 'package:xaxino/data/repo/withdraw/withdraw_history_repo.dart';
            ...
            actions: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: Icon(controller.isSearch ? Icons.clear : Icons.search, color: MyColor.colorWhite, size: 15),
                ),
              ),
          ...
          body: controller.isLoading
              ...
              : Padding(
                  ...
                  child: Column(
                    ...
                    crossAxisAlignment: controller.withdrawList.isEmpty && controller.isSearch ? CrossAxisAlignment.start : CrossAxisAlignment.center,
                    children: [
                      Visibility(
