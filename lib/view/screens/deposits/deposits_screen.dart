...
import 'package:xaxino/data/controller/deposit/deposit_history_controller.dart';
import 'package:xaxino/view/components/text-form-field/no_data_tile.dart';
import 'package:xaxino/view/screens/deposits/widget/custom_deposits_card.dart';
import 'package:xaxino/view/screens/deposits/widget/deposit_bottom_sheet.dart';
import 'package:xaxino/view/screens/deposits/widget/deposit_history_top.dart';
              ...
              appBar: AppBar(
                ...
                actions: [
                  GestureDetector(
                    ...
                    child: Container(padding: const EdgeInsets.all(Dimensions.space7), decoration: const BoxDecoration(color: MyColor.searchFieldColor, shape: BoxShape.circle), child: Icon(controller.isSearch ? Icons.clear : Icons.search, color: MyColor.colorWhite, size: 15)),
                  ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: const BoxDecoration(color: MyColor.searchFieldColor, shape: BoxShape.circle),
                      ...
                      child: Column(
                        ...
                        children: [
                         ...
                         controller.depositList.isEmpty && controller.searchLoading == false ?
                          NoDataTile(title: MyStrings.noDepositFound.tr, hasActionButton: true,
                            onTap: () {
                              Get.toNamed(RouteHelper.newDepositScreenScreen);
                            },
