...
import 'package:xaxino/data/controller/account/change_password_controller.dart';
import 'package:xaxino/data/repo/account/change_password_repo.dart';
import 'package:xaxino/data/services/api_service.dart';
import 'package:xaxino/view/components/app-bar/custom_appbar.dart';
import 'package:xaxino/view/screens/account/change-password/widget/change_password_form.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: CustomAppBar(isShowBackBtn: true, title: MyStrings.changePassword.tr, bgColor: MyColor.bottomColor),
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: regularExtraLarge.copyWith(color: MyColor.getTextColor(), fontWeight: FontWeight.w500,fontFamily: "Inter"),
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      style: regularDefault.copyWith(color: MyColor.getTextColor().withOpacity(0.8),fontFamily: "Inter"),
                    ),
                  ),
