...
import 'package:xaxino/data/controller/privacy/privacy_controller.dart';
import 'package:xaxino/data/repo/privacy_repo/privacy_repo.dart';
import 'package:xaxino/data/services/api_service.dart';
import 'package:xaxino/view/components/app-bar/custom_appbar.dart';
import 'package:xaxino/view/components/buttons/category_button.dart';
        ...
        builder: (controller) => SizedBox(
          ...
          child: controller.isLoading ? const CustomLoader() : Column(
            ...
            children: [
                    ...
                    child: Row(
                      ...
                      children: List.generate(
                        controller.list.length, (index) => Row(
                          children: [
                            CategoryButton(
                              color: controller.selectedIndex == index ? MyColor.primaryColor : MyColor.searchFieldColor,
                              horizontalPadding: 8,
                              verticalPadding: 7,
                              textColor: controller.selectedIndex == index?MyColor.colorBlack:MyColor.colorWhite,
             ...
             controller.selectedHtml!=""? Expanded(
                child:  Center(
                  child: SingleChildScrollView(
                    child: Container(
                      ...
                      child: HtmlWidget(
                        ...
                        textStyle: regularDefault.copyWith(color: MyColor.colorWhite,fontFamily: "Inter"),
