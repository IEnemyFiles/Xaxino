...
import 'package:xaxino/data/repo/gamelog/gamelog_repo.dart';
import 'package:xaxino/data/services/api_service.dart';
import 'package:xaxino/view/components/animated_widget/expanded_widget.dart';
...
import 'package:xaxino/view/screens/game_log/widgets/log_details_bottom_sheet.dart';
                    ...
                    if (controller.isLoading) {
                      ...
                      return  controller.gameLogList.isEmpty
                          ? const Column(
                            ...
                            children: [
                              NoDataTile(title: MyStrings.noGameLogFound),
                            ],
                          )
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return InkWell(
                                  ...
                                  onTap: () {
                                      GameLogBottomSheet.gameLogBottomSheet(context,index);
                                  },
                                  child: Container(
                                    margin: const EdgeInsets.all(Dimensions.space5),
                                    padding: const EdgeInsets.all(Dimensions.space10),
                                    decoration: BoxDecoration(color: MyColor.searchFieldColor, borderRadius: BorderRadius.circular(4)),
                                    child: Column(
                                      children: [
                                        Row(
                                          children: [
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  controller.currencySym + Converter.formatNumber(gameLog.invest ?? ""),
                                                  style: regularDefault.copyWith(
                                                    color: MyColor.colorWhite,
                                                  ),
                                                )
                                            ...
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                border: Border.all(
                                                  color: gameLog.winStatus == "1" ? MyColor.greenP : MyColor.redColor,
                                                ),
                                                borderRadius: BorderRadius.circular(5),
                                              ),
                                              child: Text(
                                                gameLog.winStatus == "1" ? MyStrings.win.tr : MyStrings.lost.tr,
                                                  ...
                                                  children: [
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          gameLog.result?.replaceAll("[", "").replaceAll("]", "").replaceAll('"', "").tr ?? "",
                                                          style: regularDefault.copyWith(
                                                    ...
                                                    gameLog.userSelect != "null"
                                                        ? Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                gameLog.userSelect?.replaceAll("[", "").replaceAll("]", "").replaceAll('"', "").tr ?? "",
                                                                style: regularDefault.copyWith(
                                                                  color: MyColor.textColor2,
                                                                ),
                                                              )
