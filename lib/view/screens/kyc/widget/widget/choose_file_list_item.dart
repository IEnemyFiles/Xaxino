      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: MyColor.colorWhite.withOpacity(0.04), borderRadius: BorderRadius.circular(5)),
          ...
          Expanded(
            flex: 5,
            child:Text(fileName.tr,style:regularDefault.copyWith(color: MyColor.colorWhite))
          ),
        ],
      ),
    );
