...
import 'package:xaxino/core/utils/my_icons.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(widget.isPending?MyStrings.kycUnderReviewMsg.tr:MyStrings.kycAlreadyVerifiedMsg.tr,style: regularDefault.copyWith(color: MyColor.colorWhite,fontSize: Dimensions.fontExtraLarge,)),
